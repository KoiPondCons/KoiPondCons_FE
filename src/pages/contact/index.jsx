...
function ContactPage() {
  ...
  const phoneNumber = "082 3132 452";
  return (
    <CommonPageTemplate className="context">
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        document.getElementById('file-label').innerText = fileName || 'Chọn tệp';
                      }}
                    />
                    <label htmlFor="file-upload" style={{ cursor: 'pointer', border: '1px solid #ccc', padding: '10px' }}>
                        <span id="file-label" style={{ fontWeight: 'bold' }}>Chọn tệp</span>
                    </label>
                  </FormItem>
                )}
                <Col span={24}>
